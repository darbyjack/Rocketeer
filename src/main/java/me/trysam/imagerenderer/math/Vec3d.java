...
public class Vec3d {
	 ...
	 */
	public static Vec3d fromLocation(final Location location) {
	 ...
	 * @return The {@link me.trysam.imagerenderer.math.Vec3d} with the coordinates of the given parameter.
	 */
	public static Vec3d fromBukkitVector(final Vector vector) {
	 ...
	 */
	public Vec3d multiplied(final float number) {
	 ...
	 */
	public double dot(final Vec3d vec) {
	 ...
	 */
	public Vec3d added(final Vec3d vec) {
